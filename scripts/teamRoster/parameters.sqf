...
GVAR(parameters) = [
	...
	"Team Roster2",	// 11 - HeaderText - Text to be shown above the Team Roster, ":SIDE:" represent's player's side (DEFAULT: "Team Roster (:SIDE:)")
	...
	"Team Roster3"			// 14 - DiaryTitle - Title in the Diary section of the Map Screen (left-most control) (DEFAULT: "Team Roster")
