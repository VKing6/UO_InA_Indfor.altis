...
_getADList = {
	...
	_sortedList = [adPositions,[_baseLoc],{_input0 distance getMarkerPos _x},"ASCEND",{(_input0 distance getMarkerPos _x > 500) && (_input0 distance getMarkerPos _x < 2500)}] call BIS_fnc_sortBy;
